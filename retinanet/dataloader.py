...
class CocoDataset(Dataset):
    ...
    def __init__(self, root_dir, file_name='annotations_train.json', transform=None):
        """
        Args:
        ...
        self.set_name = file_name.split('.')[0]
        self.transform = transform

        self.coco = COCO(os.path.join(self.root_dir, 'annotations', self.file_name))
    ...
    def load_image(self, image_index):
        ...
        path = os.path.join(self.root_dir, 'hologram', image_info['file_name'])
        img = Image.open(path)
