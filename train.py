...
trainset = CoCoDataset(root='/Users/zhangyunping/PycharmProjects/Holo_synthetic/hologram',
                       json_file='/Users/zhangyunping/PycharmProjects/Holo_synthetic/annotations/annotations.json', train=True, transform=transform, input_size=600)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=False, num_workers=8, collate_fn=trainset.collate_fn)

testset = CoCoDataset(root='/Users/zhangyunping/PycharmProjects/Holo_synthetic/hologram',
                      json_file='/Users/zhangyunping/PycharmProjects/Holo_synthetic/annotations/annotations.json', train=False, transform=transform, input_size=600)
